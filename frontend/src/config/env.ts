...
export const env = {
    ...
    llmModel: process.env.NEXT_PUBLIC_LLM_MODEL || "openai/gpt-oss-120b",
...
if (env.isProduction && !env.groqApiKey) {
    console.warn("Warning: GROQ_API_KEY is not set in production.");
}
